...
bird_1 = Asset("assets/bird1.png", (80, 60), [WIDTH - 80 - 20, HEIGHT / 4])
bird_2 = Asset("assets/bird2.png", (80, 60), [WIDTH - 80 - 20, HEIGHT / 4])
bird_3 = Asset("assets/bird3.png", (80, 60), [WIDTH - 80 - 20, HEIGHT / 4])
flappy_bird = Asset("assets/Flappy_Bird_title.png", ((WIDTH / 3) * 2.2, HEIGHT / 8), [WIDTH / 12, HEIGHT / 4])
...
tap_bird = Asset("assets/tap_bird.png", (300, HEIGHT / 4), [270, 500])
